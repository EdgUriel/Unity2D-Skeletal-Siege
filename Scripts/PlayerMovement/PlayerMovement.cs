...
*/
        ...
        private void run(float lerpAmount)
		{
			...
			//Run sound
			//SongController.Instance.PlaySong(runSound);
		}
		#endregion
...
/*
			transform.localScale = !isMovingRight ? transform.localScale = new Vector3(-2f) : if(h menor que 0.0f) transform.localScale = new Vector.one;
